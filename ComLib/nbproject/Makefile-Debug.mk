...
${OBJECTDIR}/Src/IMP_Client.o: Src/IMP_Client.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IInc -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/IMP_Client.o Src/IMP_Client.cpp

${OBJECTDIR}/Src/IMP_ImageSizeMessageBody.o: Src/IMP_ImageSizeMessageBody.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -g -IInc -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/IMP_ImageSizeMessageBody.o Src/IMP_ImageSizeMessageBody.cpp

${OBJECTDIR}/Src/IMP_Message.o: Src/IMP_Message.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -g -IInc -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/IMP_Message.o Src/IMP_Message.cpp

${OBJECTDIR}/Src/IMP_MessageBody.o: Src/IMP_MessageBody.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -g -IInc -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/IMP_MessageBody.o Src/IMP_MessageBody.cpp

${OBJECTDIR}/Src/IMP_Server.o: Src/IMP_Server.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -g -IInc -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/IMP_Server.o Src/IMP_Server.cpp

${OBJECTDIR}/Src/IMP_ackMessageBody.o: Src/IMP_ackMessageBody.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -g -IInc -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/IMP_ackMessageBody.o Src/IMP_ackMessageBody.cpp
